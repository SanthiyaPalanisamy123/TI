...
public class TIExecutionPage extends UtilityClass {
	...
	public static void main(String[] args) throws IOException, InterruptedException, AWTException {
		...
		//buttonClick(q.getSettings());
		insleep();
		//click Documents until settings page is loading
		
        try {
        	q.getDocument();
        	waitUntilElementVisible(driver, q.getDocument()); 
        	buttonClick(q.getDocument());
		}
		catch(Exception e) {
			q.getDocument();
			waitUntilElementVisible(driver, q.getDocument()); 
		...
		//click again the TI production icon
		buttonClick(q.getButtonIcon2());
		insleep();*/
